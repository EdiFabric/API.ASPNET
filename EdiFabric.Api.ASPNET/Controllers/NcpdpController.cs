...
namespace EdiFabric.Api.ASPNET.Controllers
{
    ...
    public class NcpdpController : ControllerBase
    {
        ...
        public NcpdpController(INcpdpService ncpdpService, ILogger<NcpdpController> logger)
        {
        ...
        public async Task<IActionResult> Read([FromQuery]ReadParameters readParameters)
        {
            ...
            try
            {
                return Content(await _ncpdpService.ReadAsync(Request.Body, apiKeys.First(), readParameters.ToReadParams()), "application/json");
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Write([FromQuery] WriteParameters writeParameters)
        {
            ...
            try
            {
                ...
                await _ncpdpService.WriteAsync(Request.Body, result, apiKeys.First(), parameters);
        ...
        public async Task<IActionResult> Validate([FromQuery] ValidateParameters validateParameters)
        {
            ...
            try
            {
                return Content(await _ncpdpService.ValidateAsync(Request.Body, apiKeys.First(), validateParameters.ToValidateParams()), "application/json");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, ex.Message);
        ...
        public async Task<IActionResult> Ack([FromQuery] AckParameters ackParameters)
        {
            ...
            try
            {
                return Content(await _ncpdpService.GenerateAckAsync(Request.Body, apiKeys.First(), ackParameters.ToAckParams()), "application/json");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, ex.Message);
        ...
        public async Task<IActionResult> Analyze([FromQuery] AnalyzeParameters analyzeParameters)
        {
            ...
            try
            {
                return Content(await _ncpdpService.AnalyzeAsync(Request.Body, apiKeys.First(), analyzeParameters.ToAnalyzeParams()), "application/json");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, ex.Message);
