...
| --- | --- |
| `POST /x12/read` | `EdiFabricX12.Parse` (JSON only) |
| `POST /x12/write` | `EdiFabricX12.Build` |
| `POST /x12/validate` | `EdiFabricX12.Parse` (JSON + validation report) |
| `POST /x12/ack` | `EdiFabricX12.Parse` (JSON + validation + 999/997/TA1) |
